        ...
        while (this.messageBuffer.includes(ElectrumProtocol.statementDelimiter)) {
            ...
            while (statementParts.length > 1) {
                ...
                if (this.useLosslessJsonParser) {
                    statementList = losslessJson.parse(currentStatementList, undefined, (value) => {
                        return losslessJson.isInteger(value) && (!losslessJson.isSafeNumber(value) || parseInt(value) > Number.MAX_SAFE_INTEGER) ? BigInt(value) : parseFloat(value);
                    });
                }
                else {
            ...
            const resolveRequest = async () => {
                ...
                for (const currentPromise in this.requestPromises[requestId]) {
                    ...
                    if (response !== undefined) {
                        ...
                        const responseDataIdentifier = this.useLosslessJsonParser ? losslessJson.stringify(response) : JSON.stringify(response);
