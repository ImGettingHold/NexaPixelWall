...
declare class ElectrumConnection extends EventEmitter {
     ...
     */
    constructor(application: string, version: string, host: string, port?: number, scheme?: TransportScheme, timeout?: number, pingInterval?: number, useLosslessJsonParser?: boolean);
    /**
...
declare class ElectrumCluster extends EventEmitter {
     ...
     * @param {boolean} useLosslessJsonParser whether to use lossless json library to handle bigint in response.
     */
    constructor(application: string, version: string, confidence?: number, distribution?: number, order?: ClusterOrder, timeout?: number, pingInterval?: number, useLosslessJsonParser?: boolean);
    /**
