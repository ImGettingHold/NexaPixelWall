...
export function bytecodeToAsm(bytecode) {
    ...
    asm = asm.replace(/OP_UNKNOWN234/g, 'OP_PUSH_TX_STATE');
    asm = asm.replace(/OP_UNKNOWN235/g, 'OP_SETBMD');
    asm = asm.replace(/OP_UNKNOWN236/g, 'OP_BIN2BIGNUM');
    asm = asm.replace(/OP_UNKNOWN237/g, 'OP_EXEC');
