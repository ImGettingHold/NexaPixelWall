...
export declare class CashScriptLexer extends Lexer {
    ...
    static readonly VersionLiteral = 73;
    static readonly BooleanLiteral = 74;
    static readonly NumberUnit = 75;
    static readonly NumberLiteral = 76;
    static readonly Bytes = 77;
    static readonly Bound = 78;
    static readonly StringLiteral = 79;
    static readonly DateLiteral = 80;
    static readonly HexLiteral = 81;
    static readonly TxVar = 82;
    static readonly NullaryOp = 83;
    static readonly Identifier = 84;
    static readonly WHITESPACE = 85;
    static readonly COMMENT = 86;
    static readonly LINE_COMMENT = 87;
