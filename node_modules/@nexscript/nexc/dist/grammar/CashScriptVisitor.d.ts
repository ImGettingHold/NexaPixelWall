...
import { MerkleRootMacroExpressionContext } from "./CashScriptParser.js";
import { ContractAccessorContext } from "./CashScriptParser.js";
...
import { ParameterModifierContext } from "./CashScriptParser.js";
...
import { MerkleRootMacroContext } from "./CashScriptParser.js";
...
export interface CashScriptVisitor<Result> extends ParseTreeVisitor<Result> {
    ...
    /**
     * Visit a parse tree produced by the `MerkleRootMacroExpression`
     * labeled alternative in `CashScriptParser.expression`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitMerkleRootMacroExpression?: (ctx: MerkleRootMacroExpressionContext) => Result;
    /**
     * Visit a parse tree produced by the `ContractAccessor`
     * labeled alternative in `CashScriptParser.expression`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitContractAccessor?: (ctx: ContractAccessorContext) => Result;
    /**
    ...
    /**
     * Visit a parse tree produced by `CashScriptParser.parameterModifier`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    ...
    /**
     * Visit a parse tree produced by `CashScriptParser.merkleRootMacro`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitMerkleRootMacro?: (ctx: MerkleRootMacroContext) => Result;
    /**
