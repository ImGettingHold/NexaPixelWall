import { PrimitiveType, explicitlyCastable, implicitlyCastable, implicitlyCastableSignature, resultingType, arrayType, ArrayType, TupleType, BytesType, } from '@nexscript/utils';
...
export default class TypeCheckTraversal extends AstTraversal {
    ...
    visitUnaryOp(node) {
        ...
        switch (node.operator) {
            ...
            case UnaryOperator.INPUT_TOKEN_GROUP_ID:
            case UnaryOperator.OUTPUT_TOKEN_GROUP_ID:
            case UnaryOperator.INPUT_TOKEN_SUBGROUP_ID:
            case UnaryOperator.OUTPUT_TOKEN_SUBGROUP_ID:
            case UnaryOperator.INPUT_SUBGROUP_DATA:
            case UnaryOperator.OUTPUT_SUBGROUP_DATA:
            case UnaryOperator.OUTPUT_VISIBLE_PARAMETERS:
            case UnaryOperator.INPUT_VISIBLE_PARAMETERS:
                expectInt(node, node.expression.type);
    ...
    visitNullaryOp(node) {
        switch (node.operator) {
            ...
            case NullaryOperator.AMOUNT_IN:
            case NullaryOperator.AMOUNT_OUT:
                node.type = PrimitiveType.INT;
                return node;
            case NullaryOperator.BYTECODE:
            case NullaryOperator.ID:
            case NullaryOperator.IDEM:
                node.type = new BytesType();
                return node;
            default:
                return node;
