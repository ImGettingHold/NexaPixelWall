import { PrimitiveType } from '@nexscript/utils';
...
export class VersionError extends Error {
    constructor(actual, constraint) {
        const message = `nexc version ${actual} does not satisfy version constraint ${constraint}`;
        super(message);
        this.name = this.constructor.name;
    }
}
export class CircularDependencyError extends Error {
    constructor(contract) {
        const message = `Contract ${contract} has a circular dependency`;
        super(message);
        this.name = this.constructor.name;
    }
}
