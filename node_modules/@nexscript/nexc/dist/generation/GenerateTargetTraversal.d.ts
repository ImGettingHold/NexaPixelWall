...
export default class GenerateTargetTraversal extends AstTraversal {
    ...
    visitContractAccessor(node: ContractAccessorNode): Node;
    ...
    visitTxStateFunction(node: FunctionCallNode): Node;
    ...
    visitMerkleMacro(node: MerkleMacroNode): Node;
}
