import { PrimitiveType, BytesType } from '@nexscript/utils';
export class Node {
}
...
export class ContractNode extends Node {
    constructor(name, parameters, contracts, functions) {
        super();
        this.name = name;
...
export class ParameterNode extends Node {
    constructor(type, name, visible = false, unused = false) {
        super();
        this.type = type;
        this.name = name;
...
export class ContractAccessorNode extends Node {
    constructor(contract, accessor) {
        super();
...
export class MerkleMacroNode extends ExpressionNode {
    constructor(treeHeight, proof, leafIndex, leafHash) {
        super();
    ...
    accept(visitor) {
        return visitor.visitMerkleMacro(this);
    }
}
