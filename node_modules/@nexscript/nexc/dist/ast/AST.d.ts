import { Type } from '@nexscript/utils';
...
export declare class SourceFileNode extends Node {
    ...
    constructor(contracts: ContractNode[]);
...
export declare class ContractNode extends Node implements Named {
    ...
    nested: boolean;
    constructor(name: string, parameters: ParameterNode[], contracts: ContractNode[], functions: FunctionDefinitionNode[]);
    accept<T>(visitor: AstVisitor<T>): T;
}
...
export declare class ParameterNode extends Node implements Named, Typed {
    ...
    visible: boolean;
    unused: boolean;
    constructor(type: Type, name: string, visible?: boolean, unused?: boolean);
    accept<T>(visitor: AstVisitor<T>): T;
}
...
export declare class ContractAccessorNode extends Node {
    contract: IdentifierNode;
    accessor: string;
    constructor(contract: IdentifierNode, accessor: string);
    accept<T>(visitor: AstVisitor<T>): T;
}
...
export declare class MerkleMacroNode extends ExpressionNode {
    treeHeight: bigint;
    proof: ExpressionNode;
    leafIndex: ExpressionNode;
    leafHash: ExpressionNode;
    constructor(treeHeight: bigint, proof: ExpressionNode, leafIndex: ExpressionNode, leafHash: ExpressionNode);
    accept<T>(visitor: AstVisitor<T>): T;
}
