...
export default class AstBuilder extends AbstractParseTreeVisitor<Node> implements CashScriptVisitor<Node> {
    ...
    visitContractAccessor(ctx: ContractAccessorContext): ContractAccessorNode;
    ...
    visitMerkleRootMacroExpression(ctx: MerkleRootMacroExpressionContext): MerkleMacroNode;
    visitMerkleRootMacro(ctx: MerkleRootMacroContext): MerkleMacroNode;
}
