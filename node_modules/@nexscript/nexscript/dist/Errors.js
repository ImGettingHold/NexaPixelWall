...
(function (Reason) {
    ...
    Reason["SCRIPT_NUMBER_OVERFLOW"] = "Script number overflow";
    ...
    // need to be changed with the new release of nexa cause we used decoupled multi
    // signature check failure frpm single signature check failure
