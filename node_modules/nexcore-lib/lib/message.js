 ...
 * @returns {Boolean}
 */
Message.prototype.verify = function verify(nexaAddress, signatureString) {
 ...
 * @returns {String}
 */
Message.prototype.recoverPublicKey = function recoverPublicKey(nexaAddress, signatureString) {
  $.checkArgument(nexaAddress);
  $.checkArgument(signatureString && _.isString(signatureString));
